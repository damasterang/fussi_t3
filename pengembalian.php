	...
	<body>
		...
		<div id="main">
						...
						<?php 
							...
							if (isset($_GET['errorMsg'])) {
								...
								if ($_GET['errorMsg'] == 1) {
									...
									echo "<div>isi form terlebih dahulu</div>";
								} elseif($_GET['errorMsg'] == 3){
									echo "<div>koleksi sudah dikembalikan</div>";
								} elseif($_GET['errorMsg'] == 4){
									echo "<div>anda harus melakukan pengembalian terlebih dahulu</div>";
								}
			...
			?>">
				...
				<a href="#" class="navMenu">Atur Data Libur</a>
